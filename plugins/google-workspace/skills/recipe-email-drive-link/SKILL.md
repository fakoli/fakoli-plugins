---
description: >-
  Share a Google Drive file and email the link with a message to recipients. Trigger when user wants to share a google drive file and email the link with a message to recipients. Uses: drive, gmail.
...
> **Related skills:** This recipe uses the following service skills for detailed API reference: `gws-drive`, `gws-gmail`
