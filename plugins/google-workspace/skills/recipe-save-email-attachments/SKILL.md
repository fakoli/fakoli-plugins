---
description: >-
  Find Gmail messages with attachments and save them to a Google Drive folder. Trigger when user wants to find gmail messages with attachments and save them to a google drive folder. Uses: gmail, drive.
...
> **Related skills:** This recipe uses the following service skills for detailed API reference: `gws-gmail`, `gws-drive`
