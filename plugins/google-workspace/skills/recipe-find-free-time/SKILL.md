---
description: >-
  Query Google Calendar free/busy status for multiple users to find a meeting slot. Trigger when user wants to query google calendar free/busy status for multiple users to find a meeting slot. Uses: calendar.
