---
description: >-
  Act as a team lead using Google Workspace. Lead a team — run standups, coordinate tasks, and communicate. Trigger when user says "act as team lead", "team lead", or describes tasks related to: lead a
  team — run standups, coordinate tasks, and communicate. Uses: calendar, gmail, chat, drive, sheets. Workflows: standup-report, meeting-prep, weekly-digest, email-to-task.
