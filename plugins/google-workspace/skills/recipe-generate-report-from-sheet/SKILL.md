---
description: >-
  Read data from a Google Sheet and create a formatted Google Docs report. Trigger when user wants to read data from a google sheet and create a formatted google docs report. Uses: sheets, docs, drive.
...
> **Related skills:** This recipe uses the following service skills for detailed API reference: `gws-sheets`, `gws-docs`, `gws-drive`
