---
description: >-
  Create a Google Classroom course and invite students. Trigger when user wants to create a google classroom course and invite students. Uses: classroom.
...
> **Related skills:** This recipe uses the following service skills for detailed API reference: `gws-classroom`
