---
description: >-
  Create a Google Docs post-mortem, schedule a Google Calendar review, and notify via Chat. Trigger when user wants to create a google docs post-mortem, schedule a google calendar review, and notify via
  chat. Uses: docs, calendar, chat.
...
> **Related skills:** This recipe uses the following service skills for detailed API reference: `gws-docs`, `gws-calendar`, `gws-chat`
