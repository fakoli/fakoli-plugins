---
description: >-
  Act as an executive assistant using Google Workspace. Manage an executive's schedule, inbox, and communications. Trigger when user says "act as executive assistant", "executive assistant", or describes
  tasks related to: manage an executive's schedule, inbox, and communications. Uses: gmail, calendar, drive, chat. Workflows: standup-report, meeting-prep, weekly-digest.
