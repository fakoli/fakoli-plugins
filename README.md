...
| [fakoli-speak](plugins/fakoli-speak) | Utilities | ElevenLabs TTS for Claude Code — streaming text-to-speech with cost tracking via /speak, /stop, /voices, /cost, /autospeak |
